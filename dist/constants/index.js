...
exports.ERROR_MESSAGES = exports.DEFAULT_CONFIG = exports.API_ENDPOINTS = exports.REVIEW_PROMPT = void 0;
exports.REVIEW_PROMPT = `Act as a senior software engineer with deep expertise in TypeScript, Node.js, and GitHub Actions. Review the following code changes and provide detailed feedback.
...
exports.ERROR_MESSAGES = {
    ...
    FILE_TOO_LARGE: (size) => `File size exceeds maximum allowed size of ${size / 1000}KB`,
    FILE_TYPE_NOT_ALLOWED: (types) => `File type not allowed. Allowed types: ${types.join(', ')}`,
